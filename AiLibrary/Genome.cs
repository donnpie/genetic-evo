...
namespace AiLibrary
{
    public class Genome
    {
        ...
        /// <returns></returns>
        public Genome Mutate(Random r, out bool mutationHappened, double mutationRate = 0.001)
        {
            //TODO: write test code
            if (mutationRate < 0.0) throw new ArgumentException("Mutation rate must be greater than 0.");
